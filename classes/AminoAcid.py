...
class AminoAcid:
    def __init__(self, id: int, name: str, abbr: str, letter: str, molecular_formula: str, residue_formula: str, molecular_weight: float, residue_weight: float,
    ...
    def get_encode(self):
        onehot_data = np.zeros(23)
        onehot_data[self.id-1] = 1
    ...
    def get_hybrid_embedding(self, weights):
        weights = model.get_weights()[0]

        for aa in allAminoacids:
            aa.embedding = weights[aa.id]
